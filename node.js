...
var app = express();
// app.set('view engine's, 'handlebars');
...
app.post('/submit', (req, res) => {
  ...
  console.log("succes") // var sql1=`insert into ngo(ngo_name,email,founder_name,ngo_start_date,phone_no,address,poc_name,poc_number,password) values("${req.body.name}")`
